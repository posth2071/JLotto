package com.example.maptest.Activity;
...
import com.example.maptest.Activity.FragMent_One.FragOne;
import com.example.maptest.Activity.FragMent_One.FragOneTwo;
...
public class MainActivity extends AppCompatActivity implements BottomNavigationView.OnNavigationItemSelectedListener,
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        //로딩화면 띄우기
        Intent loading_it = new Intent(this, Loading_Activity.class);
        ...
        /*
        // 임시 테스트 로또번호 저장 (3개회차, 회차별 3개씩 저장)
        ...
        for(int j=0; j<3; j++){
            for(int i=0; i<3; i++){
                ...
                String numset = hashSet.toString()
                        .replace("[","")
                        .replace("]","")
                        .replaceAll(" ","");
                Log.d("임시", String.format("Turn - %d numset - %s", (j+880), numset));
                dbOpenHelper.insertDB((j+880), numset);
                hashSet.clear();
            }
        }
